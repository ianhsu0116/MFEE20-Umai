...
function CourseInfomation (props){
  ...
  const onChange = (e) => {
    ...
    const newCourseJSON = {
        ...
        content2: "最好設定10個字上限 \n 最好不要打符號 \n 香蕉 \n 拔辣 \n 荔枝 \n 火龍果 \n 葡萄\n 草莓\n 蘋果 \n 西瓜 \n 拔辣 \n 拔辣 \n 荔枝 \n 火龍果 \n 葡萄\n 草莓", // 費用包含內容
        content3: "最少上課人數5人，當參加人數未達上述規定的最少上課人數時，將取消課程形成，於課前5天前發出取消課程簡訊", // 注意事項說明
        ...
        <div className="Coursedetail">
          <div className="Coursedetail-info">
            <div className="Coursedetail-infoRight">
                <div><span className="Coursedetail-originalPrice">原價NT${newCourseJSON.course_price.toString().replace(/(\d)(?=(?:\d{3})+$)/g, '$1,')}</span><span className="Coursedetail-infoRightPrice">早鳥優惠價</span></div>
                <div><span className="Coursedetail-specialPrice">NT${(newCourseJSON.course_price*0.9).toString().replace(/(\d)(?=(?:\d{3})+$)/g, '$1,')}</span></div>
            ...
            <div className="Coursedetail-infoLeft">
                <div className="Coursedetail-infoLeft-breadcrumb">
                    <ul>
                        ...
                        <li>{">"}</li>
                        <li className="Coursedetail-infoLeft-breadcrumb-name">{newCourseJSON.course_name}</li>
                    </ul>
                </div>
                ...
                {/* 下面是主廚外標題 */}
                <div className="Coursedetail-outsideTitle">{newCourseJSON.title1_1}</div>
            <div className="Coursedetail-infoBox">
                <div className="Coursedetail-insideTitle"><span>{newCourseJSON.title1_2}</span></div>
                <div className="Coursedetail-whiteLine"></div>
                <div className="Coursedetail-insideText">{newCourseJSON.content1.split('\n').map(function(item) {
                  return (
                    <div>
                      {item}
                      <br/>
                ...
                <div className="Coursedetail-outsideTitle" id="chef">米其林一星主廚精心準備，絕無冷場</div>
                <div className="Coursedetail-titleLine"></div>
                <div className="Coursedetail-outsideTitle">挑戰舌尖上的味蕾，每一秒的幸福口感</div>
            ...
            <div className="Coursedetail-infoBox2">
                <div className="Coursedetail-insideTitle Coursedetail-foodInfo">{newCourseJSON.title2}</div>
                <div className="Coursedetail-whiteLine"></div>
                ...
                <div className="Coursedetail-sixPictureTextBox_1">
                    <ul>
                        ...
                        setCourse(0)
                        setCourseFoodTitle(newCourseJSON.six_dishes[0].dishes_title)
                        }}><img src={newCourseJSON.six_dishes[0].dishes_image} alt="" className={course === 0 ? "Coursedetail-ImageActive" : "Coursedetail-ImageBorderbottom"}></img>
                       <span className='Coursedetail-sixPictureTitle'>{newCourseJSON.six_dishes[0].dishes_title}</span>
                        <span className="Coursedetail-sixPictureTitleMask"></span>
                        <sapn className={course === 0 ? 'Coursedetail-activeBottom' : ''}></sapn>
                        </li>
                        <li onClick={()=> {
                        setColor("Coursedetail-chepBoxInfomation")    
                        setCourse(1)
                        setCourseFoodTitle(newCourseJSON.six_dishes[1].dishes_title)
                        }}><img src={newCourseJSON.six_dishes[1].dishes_image} alt="" className={course === 1 ? "Coursedetail-ImageActive" : "Coursedetail-ImageBorderbottom"}></img>
                        <span className='Coursedetail-sixPictureTitle'>{newCourseJSON.six_dishes[1].dishes_title}</span>
                        <span className="Coursedetail-sixPictureTitleMask"></span>
                        <sapn className={course === 1 ? 'Coursedetail-activeBottom' : ''}></sapn>
                        </li>
                        <li onClick={()=> {
                        setColor("Coursedetail-chepBoxInfomation")    
                        setCourse(2)
                        setCourseFoodTitle(newCourseJSON.six_dishes[2].dishes_title)
                        }}><img src={newCourseJSON.six_dishes[2].dishes_image} alt="" className={course === 2 ? "Coursedetail-ImageActive" : "Coursedetail-ImageBorderbottom"}></img>
                        <span className='Coursedetail-sixPictureTitle'>{newCourseJSON.six_dishes[2].dishes_title}</span>
                        <span className="Coursedetail-sixPictureTitleMask"></span>
                        <sapn className={course === 2 ? 'Coursedetail-activeBottom' : ''}></sapn>
                        </li>
                    </ul> 
                    <ul>
                        <li onClick={()=> {
                        setColor("Coursedetail-chepBoxInfomation")    
                        setCourse(3)
                        setCourseFoodTitle(newCourseJSON.six_dishes[3].dishes_title)
                        }}><img src={newCourseJSON.six_dishes[3].dishes_image} alt="" className={course === 3 ? "Coursedetail-ImageActive" : "Coursedetail-ImageBorderbottom"}></img>
                        <span className='Coursedetail-sixPictureTitle'>{newCourseJSON.six_dishes[3].dishes_title}</span>
                        <span className="Coursedetail-sixPictureTitleMask"></span>
                        <sapn className={course === 3 ? 'Coursedetail-activeBottom' : ''}></sapn>
                        </li>
                        <li onClick={()=> {
                        setColor("Coursedetail-chepBoxInfomation")    
                        setCourse(4)
                        setCourseFoodTitle(newCourseJSON.six_dishes[4].dishes_title)
                        }}><img src={newCourseJSON.six_dishes[4].dishes_image} alt="" className={course === 4 ? "Coursedetail-ImageActive" : "Coursedetail-ImageBorderbottom"}></img>
                        <span className='Coursedetail-sixPictureTitle'>{newCourseJSON.six_dishes[4].dishes_title}</span>
                        <span className="Coursedetail-sixPictureTitleMask"></span>
                        <sapn className={course === 4 ? 'Coursedetail-activeBottom' : ''}></sapn>
                        </li>
                        <li onClick={()=> {
                        setColor("Coursedetail-chepBoxInfomation")    
                        setCourse(5)
                        setCourseFoodTitle(newCourseJSON.six_dishes[5].dishes_title)
                        }}><img src={newCourseJSON.six_dishes[5].dishes_image} alt="" className={course === 5 ? "Coursedetail-ImageActive" : "Coursedetail-ImageBorderbottom"}></img>
                        <span className='Coursedetail-sixPictureTitle'>{newCourseJSON.six_dishes[5].dishes_title}</span>
                        <span className="Coursedetail-sixPictureTitleMask"></span>
                        <sapn className={course === 5 ? 'Coursedetail-activeBottom' : ''}></sapn>
                        </li>
                    </ul>
                </div>
                ...
                <div className="Coursedetail-chepBoxTextWidth">
                    ...
                    <div className="Coursedetail-chepBoxTitle">{courseFoodTitle}
                        <div className={color}>{newCourseJSON.six_dishes[course].dishes_content.split('\n').map(function(item) {
                        return (
                            <div>
                                {item}
                                <br/>
            ...
            <CourseCost content={newCourseJSON.content2} attention={newCourseJSON.content3}/>
