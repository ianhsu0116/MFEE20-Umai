...
function Course(props) {
  ...
  useEffect(() => {
    if (
      selectedOptionStart === "評分由高到低" &&
      selectedOptionDate === "離今日最近"
    ) {
      let TrueArrow = [...category]
        .filter(function (item) {
          return item.closest_batchs?.batch_date != null;
        ...
        .sort(function (a, b) {
          ...
          return (isNaN(a.score_sum / a.score_count)
            ...
            (isNaN(b.score_sum / b.score_count)
              ? 0
              : b.score_sum / b.score_count)
            ? 1
            : -1;
        })
        .sort(function (a, b) {
  ...
  return (
    <>
      ...
      <div className="Course">
        ...
        <div className="CourseVideo">
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/MKdvHnTk0xs"
      ...
      <div className="CourseSixBox"></div> */}
        ...
        <div className="CourseCard">{categoryCard}</div>
      </div>
    </>
  );
}
